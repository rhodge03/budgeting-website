...
export async function create(earnerId: string, body: { label: string; amount: number; isTaxable?: boolean; durationYears?: number | null; growthRate?: number | null }): Promise<IncomeEntry> {
